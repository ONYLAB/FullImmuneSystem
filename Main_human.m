...
% Subsequent doses
for num_dose=1:40  % number of doses, protein specific
...
% NT,	Naïve helper T cells, number of cells
...
% NB,	Naïve B cells, number of cells
...
save(savefile, 'a','koff', 't_record','AgIS_vector','Ag_vector','Agec_vector','Agp_vector', 'MS_vector','ID_vector','MD_vector',...
